...
describe "google_plus_data/new" do
  before(:each) do
    assign(:google_plus_datum, stub_model(GooglePlusDatum,
      :client_id => 1,
      :social_network_id => 1,
      :new_followers => 1,
      :total_followers => 1,
  ...
  it "renders new google_plus_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => google_plus_data_path, :method => "post" do
