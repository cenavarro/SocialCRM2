...
describe "benchmark_data/new" do
  before(:each) do
    assign(:benchmark_datum, stub_model(BenchmarkDatum,
      :client_id => 1,
      :social_network_id => 1,
      :start_date => 1,
      :end_date => 1,
  ...
  it "renders new benchmark_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => benchmark_data_path, :method => "post" do
