...
describe "blog_data/new" do
  before(:each) do
    assign(:blog_datum, stub_model(BlogDatum,
      :client_id => 1,
      :social_network_id => 1,
      :unique_visits => 1,
      :visit_pages => 1,
  ...
  it "renders new blog_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => blog_data_path, :method => "post" do
