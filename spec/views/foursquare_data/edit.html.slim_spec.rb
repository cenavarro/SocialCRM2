...
describe "foursquare_data/edit" do
  before(:each) do
  ...
  it "renders the edit foursquare_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => foursquare_data_path(@foursquare_datum), :method => "post" do
