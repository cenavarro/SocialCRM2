...
describe "internal_monitoring_data/new" do
  before(:each) do
    assign(:internal_monitoring_datum, stub_model(InternalMonitoringDatum,
      :client_id => 1,
      :social_network_id => 1,
      :complaints => 1,
      :client_att => 1,
  ...
  it "renders new internal_monitoring_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => internal_monitoring_data_path, :method => "post" do
