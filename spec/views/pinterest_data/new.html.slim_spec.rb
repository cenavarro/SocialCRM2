...
describe "pinterest_data/new" do
  before(:each) do
    assign(:pinterest_datum, stub_model(PinterestDatum,
      :new_followers => 1,
      :total_followers => 1,
      :boards => 1,
      :pins => 1,
  ...
  it "renders new pinterest_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => pinterest_data_path, :method => "post" do
