...
describe TwitterDataController do
  ...
  # TwitterDatum. As you add validations to TwitterDatum, be sure to
  ...
  # TwitterDataController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested twitter_datum as @twitter_datum" do
      twitter_datum = TwitterDatum.create! valid_attributes
      get :show, {:id => twitter_datum.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested twitter_datum as @twitter_datum" do
      twitter_datum = TwitterDatum.create! valid_attributes
      get :edit, {:id => twitter_datum.to_param}, valid_session
      assigns(:twitter_datum).should eq(twitter_datum)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new TwitterDatum" do
        expect {
          post :create, {:twitter_datum => valid_attributes}, valid_session
      ...
      it "redirects to the created twitter_datum" do
        post :create, {:twitter_datum => valid_attributes}, valid_session
        response.should redirect_to(TwitterDatum.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved twitter_datum as @twitter_datum" do
        ...
        post :create, {:twitter_datum => {}}, valid_session
        assigns(:twitter_datum).should be_a_new(TwitterDatum)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested twitter_datum" do
        twitter_datum = TwitterDatum.create! valid_attributes
        # Assuming there are no other twitter_data in the database, this
        # specifies that the TwitterDatum created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        TwitterDatum.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => twitter_datum.to_param, :twitter_datum => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested twitter_datum as @twitter_datum" do
        twitter_datum = TwitterDatum.create! valid_attributes
        put :update, {:id => twitter_datum.to_param, :twitter_datum => valid_attributes}, valid_session
        assigns(:twitter_datum).should eq(twitter_datum)
      end
      ...
      it "redirects to the twitter_datum" do
        twitter_datum = TwitterDatum.create! valid_attributes
        put :update, {:id => twitter_datum.to_param, :twitter_datum => valid_attributes}, valid_session
        response.should redirect_to(twitter_datum)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the twitter_datum as @twitter_datum" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TwitterDatum.any_instance.stub(:save).and_return(false)
        put :update, {:id => twitter_datum.to_param, :twitter_datum => {}}, valid_session
        assigns(:twitter_datum).should eq(twitter_datum)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested twitter_datum" do
      twitter_datum = TwitterDatum.create! valid_attributes
      expect {
        delete :destroy, {:id => twitter_datum.to_param}, valid_session
      }.to change(TwitterDatum, :count).by(-1)
    end
    ...
    it "redirects to the twitter_data list" do
      twitter_datum = TwitterDatum.create! valid_attributes
      delete :destroy, {:id => twitter_datum.to_param}, valid_session
      response.should redirect_to(twitter_data_url)
    end
  end
